...
<body>
    ...
    <section>
        ...
        <form
            ...
            action="{{ route('update-projek', $projek->id) }}"
            >
            @csrf
            @method('PUT')
            <div class="mb-3">
            ...
            <div class="mb-3">
              ...
              <textarea
                ...
                class="form-control"
                required
                style="resize:none;">{{ $projek->deskripsi }}</textarea>
            </div>
            <div class="mb-3">
                <label for="foto_projek" class="form-label">Foto Projek</label>
                <input type="file" name="foto_projek" class="form-control" id="foto_projek" value="{{ $projek->link_foto }}">
            </div>
